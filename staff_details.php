...
if (isset($_POST['delete_btn'])) {
	...
	$checking = mysqli_query($conn,"SELECT * FROM staff WHERE ID = '$key' ") or die("Data Not Found".mysql_error());
	if (mysqli_num_rows($checking)>0) {
		$result = mysqli_query($conn,"DELETE FROM staff WHERE ID = '$key' ");
		...
		<div class="card">
			<div class="card-body" style="background-color: #3A81FF; color: white;">
				<div class="row">
					...
					<div class="col-md-4"><h3 style="color: white; font-family: serif;">Staff Details</h3></div>
					<div class="col-md-7">
						<form class="form-group" action="staff_list.php" method="post">
							<div class="row">
							...
							<div class="col-md-2">
							<input type="submit" name="staff_search" class="btn btn-dark" value="Search"></div>
							</div>
						</form>
					</div>
				</div>
