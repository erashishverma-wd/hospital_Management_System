...
<div class="container" align="right">
	<div class="card" style="width: 350px; margin-top: 220px;" align="left">
		<div class="card-body" style="background-color:#1D9DEF  ">
			...
			<input type="text" name="old" autocomplete="off" class="form-control" required>
			...
			<div align="right">
				<input type="submit" name="change_btn_mng" value="Done" class="btn btn-warning" style="margin-top: 15px;">
			</div>
			</form>
		</div>
	</div>
